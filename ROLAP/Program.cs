...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Parser.Parse("SELECT {CROSSJOIN([Dimension].[University],[Dimension].[FactAndPlan]),CROSSJOIN({[Dimension].&[TGU],[Dimension].&[TPU]},{[Dimension].[FactAndPlan],[Dimension].[Fact],[Dimension].[Plan]})} ON 0, [Product].[Color].&[Black] ON 1 FROM [Adventure_Cube]");
